...
survey
	...
	.add(function(sender, options){
		...
		AdobeUtils.sendEvent(surveyId, options.newCurrentPage.name, survey.locale!=""?survey.locale:languageCode);
...
AdobeUtils.sendEvent(surveyId, survey.currentPage.name, survey.locale!=""?survey.locale:languageCode);
