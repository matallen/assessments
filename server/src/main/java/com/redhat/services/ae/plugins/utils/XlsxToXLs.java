...
//		if (this.path.isFile()){
//			if (this.path.getAbsolutePath().endsWith(".xls") && !new File(this.path.getAbsolutePath() + "x").exists())
//				this.inputFiles.add(this.path);
//			else{
//				System.out.println("Datei endet nicht mit .xls oder XLSX-Datei existiert bereits");
//			}
//		}else
...
//				}
//			}
//		System.out.println(call + "Dateien gefunden: " + this.inputFiles.size());
//		System.out.println(call + "abgeschlossen");
//	}
//
//	private HSSFWorkbook getWorkBook(File f) throws FileNotFoundException, IOException{
...
//		 * (XSSFCellStyle)rowOld.getRowStyle(),(HSSFCellStyle)workbookNew.
//		 * createCellStyle()); rowNew.setRowStyle(this.styleMap.get(hash)); }
//		 */
...
//	}
//
//	public File convert(File srcXlsx, File outFile) throws FileNotFoundException, IOException{
//		XSSFWorkbook old=new XSSFWorkbook(new FileInputStream(srcXlsx));
//		HSSFWorkbook workbookNew=new HSSFWorkbook();
//		FileOutputStream out=new FileOutputStream(outFile);
//		new XlsxToXLs().transformXSSF(old, workbookNew);
//		workbookNew.write(out);
//		out.close();
//		return outFile;
//	}
//	public static void main(String[] args) throws Exception{
//		XlsxToXLs converter=new XlsxToXLs();
//		// xls.transform();
//		XSSFWorkbook old=new XSSFWorkbook(new FileInputStream("/home/mallen/google_drive/19d03Qi0mr-9mcfYp9__sjNkFJcGCx2zT4D26NYH1US4/Red Hat Assessment Recommendation Rules - DMZZIW.xlsx"));
//
//		FileOutputStream out=new FileOutputStream("/home/mallen/google_drive/19d03Qi0mr-9mcfYp9__sjNkFJcGCx2zT4D26NYH1US4/Red Hat Assessment Recommendation Rules - DMZZIW.xls");
//		HSSFWorkbook workbookNew=new HSSFWorkbook();
//		converter.transformXSSF(old, workbookNew);
//		workbookNew.write(out);
//
//		out.close();
//
