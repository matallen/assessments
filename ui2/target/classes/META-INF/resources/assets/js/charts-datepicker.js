...
function getCYYear(d){
	return (d.getFullYear()+"").slice(0,2);
}
function getCYQ(d){
...
function generateDateRangeSelect(name, selected){
	...
	var minus3months=dateToYYYYMMM(dateMinusMonths(lastMonth,2));
	var minus6months=dateToYYYYMMM(dateMinusMonths(lastMonth,5));
	var minus9months=dateToYYYYMMM(dateMinusMonths(lastMonth,8));
...
//	result+="<option "+(selected=="Current Month"?"selected":"")+" value='start="+currentMonthYYYYMMM+"&end="+currentMonthYYYYMMM+"' data-start='"+currentMonthYYYYMMM+"' data-end='"+currentMonthYYYYMMM+"'>Current Month</option>";
	...
	result+="<option "+(selected=="3 Months"?"selected":"")+"   value='start="+minus3months+"&end="+lastMonthYYYYMMM+"'     data-start='"+minus3months+"'     data-end='"+lastMonthYYYYMMM+"'>3 Months</option>";
	result+="<option "+(selected=="6 Months"?"selected":"")+"   value='start="+minus6months+"&end="+lastMonthYYYYMMM+"'     data-start='"+minus6months+"'     data-end='"+lastMonthYYYYMMM+"'>6 Months</option>";
	result+="<option "+(selected=="9 Months"?"selected":"")+"   value='start="+minus9months+"&end="+lastMonthYYYYMMM+"'     data-start='"+minus9months+"'     data-end='"+lastMonthYYYYMMM+"'>9 Months</option>";
